...
function update_canvas(){
    ...
    document.getElementById("sketch_drawn").innerHTML="Sketch to be drawn: " + quick_draw_data_set[random_number];
} 
...
function gotResult(error,results){
    ...
    console.log(results);
    document.getElementById('your_sketch').innerHTML = 'Your Sketch is ' + results[0].label;
